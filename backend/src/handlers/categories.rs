...
pub async fn list_categories(
    ...
    tracing::debug!(user_id = %auth.user_id, "list_categories: received request");
    let categories = services::category::get_all_categories_with_subs(&state.pool, auth.user_id).await?;
    tracing::debug!(user_id = %auth.user_id, count = categories.len(), "list_categories: returning categories");
    Ok(Json(categories))
}
...
pub async fn get_category(
    ...
    tracing::debug!(user_id = %auth.user_id, category_id = %id, "get_category: received request");
...
pub async fn create_category(
    ...
    tracing::debug!(user_id = %auth.user_id, ?req, "create_category: received request");
    let category =
...
pub async fn update_category(
    ...
    tracing::debug!(user_id = %auth.user_id, category_id = %id, ?req, "update_category: received request");
    let category =
...
pub async fn delete_category(
    ...
    tracing::debug!(user_id = %auth.user_id, category_id = %id, "delete_category: received request");
...
pub async fn list_subcategories(
    ...
    tracing::debug!(user_id = %auth.user_id, category_id = %category_id, "list_subcategories: received request");
    let subs =
...
pub async fn create_subcategory(
    ...
    tracing::debug!(user_id = %auth.user_id, category_id = %category_id, ?req, "create_subcategory: received request");
    let sub =
...
pub async fn update_subcategory(
    ...
    tracing::debug!(user_id = %auth.user_id, sub_id = %id, ?req, "update_subcategory: received request");
    let sub =
...
pub async fn delete_subcategory(
    ...
    tracing::debug!(user_id = %auth.user_id, sub_id = %id, "delete_subcategory: received request");
